  ...
  return (
    <div className="w-screen h-screen flex justify-center items-center">
      <div className="w-1/2 bg-primary rounded-tr-2xl rounded-br-2xl h-full flex flex-col justify-center items-center gap-2">
        <h1 className="text-4xl relative text-slate-50 font-semibold before:absolute before:w-large before:h-large before:rounded-full before:bg-blue-200 before:opacity-10  before:-translate-x-1/2 before:-translate-y-1/2  before:left-1/2 before:top-1/2 after:absolute after:w-extraLarge after:h-extraLarge after:rounded-full after:bg-blue-200 after:opacity-15  after:-translate-x-1/2 after:-translate-y-1/2  after:left-1/2 after:top-1/2">
