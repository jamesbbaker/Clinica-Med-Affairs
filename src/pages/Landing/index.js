    ...
    <>
      ...
      <section className="w-full flex flex-col justify-center items-center relative h-[100vh]">
        ...
        <div className="z-2  rounded-xl px-12 py-10 flex flex-col items-center justify-center gap-4">
          <h2 className="text-[3rem] max-w-[70%] text-[#fff] text-center font-[400]">
          ...
          <div className="h-[10rem] p-2 flex items-center gap-2 rounded-lg">
            ...
            <PrimaryBtn text={"Request a Demo"} bg={"#c4c4c4"} className={"px-10 text-2xl hover:scale-105 text-[#000]"} />
            <PrimaryBtn text={"Talk to an Expert"} bg={"#c4c4c4"}  className={"px-10  text-2xl hover:scale-105 text-[#000]"} />
          </div>
        </div>
      </section>
                  ...
                  <div className=" grid grid-cols-1 custom:grid-cols-2">
                    <div className="flex h-full justify-center col-span-1 flex-col items-center gap-4">
                      ...
                      <PrimaryBtn
                        ...
                        text={"Learn more"}
                        className={"px-10 text-2xl text-[#fff]"}
                      />
                    </div>
      ...
      <section className="min-h-[50vh] md:px-20 px-10 bg-gray-100 z-2 grid grid-cols-1">
        <div className="grid px-10 bg-gray-100 place-content-center">
        ...
        <div className="grid gap-6 md:grid-cols-3 grid-cols-1 mb-20 bg-gray-100">
          {texts.map((text, index) => (
            <div
              key={index}
              className={`transition-opacity text-xl text-center grid place-content-center duration-700 ease-in-out`}
            >
              {text}
            </div>
          ))}
      ...
      <section className="grid bg-slate-200 px-10 py-20 grid-cols-2">
        <div className="px-10 grid place-content-center py-10">
          <PrimaryBtn text={"Request a Demo"} className={"px-10 text-2xl text-[#fff]"} />
        </div>
        <div className="px-10 grid place-content-center py-10">
          <PrimaryBtn
